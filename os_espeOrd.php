		...
		<div id="tabs">
			...
			<div id="tabs-1">
				<div class="cs_pesGene" >
					<label id="lbl" >OS:</label>
					<span class="campo" ><u>OS-2014-0101-1</u></span>
					<label id="lbl" >CC:</label>
					<span class="campo" ><u><a href="<?php print "Javascript:cs_loadEvent('direCenCost','".$pcId."','')"; ?>" >CC-0101</a></u></span>
				...
				<div class="cs_pesGene" >
					...
					<label id="lbl" ></label>
					<button class="campo cs_ejeRepCot" onclick="<?php print "Javascript:cs_loadEvent('ejeRepoOrd','".$_GET['id']."','')"; ?>" >Ejecutar</button>
				</div>
			</div>
			<div id="tabs-2" >
...
<!--  POPUP DIALOG 2 -->
<div id="dialog2"  title="Reporte orden de servicio" >
