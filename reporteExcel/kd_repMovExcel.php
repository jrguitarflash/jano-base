...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B1', 'Movimiento')
            ->setCellValue('C1', 'Fecha')
            ->setCellValue('D1', 'N° Doc')
...
// DATA ITERADA
	...
	foreach ($dataHistKardx as $data) 
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue('B'.$i,$data['tipMovDes'])
							->setCellValue('C'.$i,$data['fechMov'])
							->setCellValue('D'.$i,$data['tipDocDes'])
							->setCellValue('E'.$i,$data['empDes'])
							->setCellValue('F'.$i++,'=SUBSTITUTE("'.$data['detProd'].'","<br>",CHAR(10))');
	}
...
header('Content-Disposition: attachment;filename="kd_repMovExcel.xlsx"');
