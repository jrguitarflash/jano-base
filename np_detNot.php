...
<div class="box">
	...
	<div class="heading" >
		...
		<input type="hidden" id="np_view" value="np_detNot" >
		<input type="hidden" id="np_detId" name="np_detId" value="<?php print $_GET['id']; ?>" >
		<h1 id="np_titView" ></h1>

		<div class="buttons" >
			<a href="#" id="np_acciActuNot" >Guardar</a> <!-- Accion -->
			|
	...
	<div class="content" >
		...
		<form name="frmNotNuev" >
			...
			<span class="campo" ><?php print $cod; ?></span>
			...
			<input type="hidden" id="np_tipId" value="<?php print $tipId; ?>" >

			<label id="lbl2" >Cliente:</label>
			<input type="text" class="campo kd_campDina" id="np_cliDes" size="45" value="<?php print $cli; ?>" >
			<input type="hidden" class="campo" id="np_cliId" name="np_cliId" value="<?php print $cliId; ?>" >

			<label id="lbl2" style="display:none">Fecha:</label>
			<span class="campo" style="display:none" ><input type="text" id="np_fech" name="np_fech" value="<?php print $fech; ?>" ></span>

			<label id="lbl2" >Fecha atencion:</label>
			<span class="campo" ><input type="text" id="np_fechConfir" name="np_fechConfir" value="<?php print $fechConfir; ?>" ></span>
			...
			<textarea class="campo" id="np_des" name="np_des" ><?php print $des; ?></textarea>
			<label id="lbl2" >Referencia:</label>
			<input type="text" class="campo" id="np_ref" name="np_ref" value="<?php print $des; ?>" >
			<label id="lbl2" >Observacion:</label>
			<textarea class="campo" id="np_obs" name="np_obs" ><?php print $obs; ?></textarea>

			<!-- estado de notas de pedido -->
			<label id="lbl2" >Estado:</label>
			<select class="campo" id="np_estaNot" name="np_estaNot">
			...
			<input type="hidden" id="np_estaId" value="<?php print $estaId; ?>" >
...
<div id="np_lineProd" title="Linea de Productos">
		...
		<fieldset class="kd_filProd2" >
			...
			<label id="lbl2" ></label>
			<button class="campo" id="np_acciNuevItem" >Agregar</button>
		</fieldset>
