...
function header()
{
	...
	//titulo del reporte
	$this->SetFont('Arial','',10);
	$this->cell(125,10,"Responsable: ".utf8_decode($_GET['resp']),0,1,'R');
	$this->SetFont('Arial','B',15);
	$this->Cell(120,10,'REPORTE DE RECLAMO',0,0,'R');
	//titulo del reporte
	$this->SetFont('Arial','',10);
	$this->cell(75,10,utf8_decode("Fecha de recepción: ").$_GET['fech'],0,1,'R');
	$this->Cell(120);
...
$dataRe=negocio::getData($sql);
$dataRecla=array();
$i=0;

/*
foreach($dataRe as $dataRe)
{
...
//-------------------------------------HEADER DATOS----------------------------------//
	   ...
	   $pdf->SetFont('Arial','B',10);
		$pdf->Cell(70,10,utf8_decode('N° de Reporte: ')."RE".str_pad($_GET['id'],5,'0',STR_PAD_LEFT),0,0,'L');
		$pdf->SetFont('Arial','B',10);
...
$sql1=sql::getTipReclamoxId($dataRe[0]['idTipReclamo']);
$sql6=sql::getClixContacxCli($dataRe[0]['idEmpReclamo']);
$sql2=sql::getContacxId($dataRe[0]['idContacReclamo']);
$sql3=sql::getTrabVendedorxId($dataRe[0]['idRespoReclamo']);
$sql4=sql::getEstaRecla($dataRe[0]['idEstaReclamo']);

$pdf->Cell(50,10,"Tipo:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,negocio::getVal($sql1,'desTipReclamo'),1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Fecha recepcion:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,$dataRe[0]['fechReclamo'],1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Cliente:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,negocio::getVal($sql6,'empresa'),1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Contacto:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,negocio::getVal($sql2,'contacto'),1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Responsable:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,utf8_decode(negocio::getVal($sql3,'vendedor')),1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Estado:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,negocio::getVal($sql4,'desEstaReclamo'),1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Descripcion:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,$dataRe[0]['desReclamo'],1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Acciones ordenadas:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,$dataRe[0]['acciReclamo'],1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,10,"Acciones Realizadas:",1,0,'L');
$pdf->SetFont('Arial','',10);
$pdf->MultiCell(140,10,$dataRe[0]['acciReliReclamo'],1,'L');
