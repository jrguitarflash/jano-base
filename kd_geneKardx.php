...
<div class="box" >
	...
	<div class="content" >
		...
		<form name="frmGenMov" id="frmGenMov" >
			...
			<label id="lbl2" >Fabricante:</label>
			<input type="text" class="campo kd_campDina"  id="kd_empDes" size="45">
			...
			<input type="radio" class="campo" name="kd_doc" id="kd_doc" value="3" >
			<span class="campo" id="kd_lblDua" >Dua</span>
